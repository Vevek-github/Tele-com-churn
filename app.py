...
import testing_telecom_without_pipelines
...
if choice == "Result":
    ...
    if predict_button:
        hello =testing_telecom_without_pipelines.input_run(df)
        ...
        col1=st.write(hd)
        col2 = st.image("EDA images\modelcompare.png")
    ...
    if Model_importances:
        ...
        col4 = st.image(r"EDA images\feature_importances_of_gb.png")
